...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230925210149_UpdateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Features.QuestionFeature.Options.CharLimitOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_char_limit_options");

                    b.ToTable("char_limit_options", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Features.QuestionFeature.OpenQuestion", b =>
                {
                    b.HasOne("Domain.Features.UserFeature.User", "User")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_open_questions_users_user_id");
            ...
            modelBuilder.Entity("OpenQuestionTopicTag", b =>
                {
                    ...
                    b.HasOne("Domain.Features.TagFeature.TopicTag", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_open_question_topic_tags_topic_tags_tags_id");
                });
            ...
            modelBuilder.Entity("OpenQuestionUser", b =>
                {
                    ...
                    b.HasOne("Domain.Features.UserFeature.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_open_question_likes_users_users_id");
                });
            ...
            modelBuilder.Entity("QuestionnaireTopicTag", b =>
                {
                    ...
                    b.HasOne("Domain.Features.TagFeature.TopicTag", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_questionnaire_topic_tags_topic_tags_tags_id");
                });
            ...
            modelBuilder.Entity("QuestionnaireUser", b =>
                {
                    ...
                    b.HasOne("Domain.Features.UserFeature.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_questionnaire_likes_users_users_id");
                });
